...
Let $G$ be a $DAG$, P = ($P_0$,...,$P_t$) be an arbitrary pebbling of $G$ and $¦°$ be the set of all complete pebblings of $G$. Then the (cumulative) cost of $P$ and then cumulative complexity ($CC$) of $G$ are defined respectively to be:\\
  \begin{equation}
